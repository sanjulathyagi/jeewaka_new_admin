                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            ...
                            <form role="form" method="POST" action="{{ route('register') }}">
                                ...
                                @error('name')
                                <div class="alert alert-danger"> name : {{ $message }}</div>
                                @enderror
                                <div class="mb-3">
                                ...
                                @error('email')
                                <div class="alert alert-danger"> email : {{ $message }}</div>
                                @enderror
                                <div class="mb-3">
                                ...
                                @error('password')
                                <div class="alert alert-danger"> password : {{ $message }}</div>
                                @enderror
                                <div class="mb-3">
                                    <input type="password" class="form-control" placeholder="confirm password"
                                        aria-label="Password" name="password_confirmation" required
